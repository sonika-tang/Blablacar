...
class _BlaLocationPickerState extends State<BlaLocationPicker> {
  ...
  List<Location> filterLocations(List<Location> all) {
  ...
  Widget build(BuildContext context) {
    // Read the repository — no more LocationsService.availableLocations
    final allLocations = context.read<LocationRepository>().fetchLocation();
    final filtered = filterLocations(allLocations);
